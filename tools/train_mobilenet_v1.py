from yolov3.solver.mobilenet_v1_solver import TrainMobileNet_V1_Solver
...
def get_parser():
    ...
    parser.add_argument('--backbone_name',default="build_MobileNet_V1_backbone", type=str, help='name of model')
...
def trainer():
    cfg = setup()
    trainer = TrainMobileNet_V1_Solver(cfg)
    trainer.train()
