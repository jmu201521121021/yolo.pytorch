...
def get_parser():
    ...
    parser.add_argument('--decay_epoch', default=70, type=int, help='decay epoch of learning rate')
    ...
    parser.add_argument('--test_transform', default=["ReadImage()","ResizeImage(320, 320)","CenterCrop(224)","ToTensor()", "Normalize()"], type=list, help="test data transform")
