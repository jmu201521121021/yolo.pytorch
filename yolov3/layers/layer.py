...
def get_activate(activate, alpha=None):
    """
    Args:
        norm (str or callable):

    Returns:
        nn.Module or None: the activate layer
    """
    if isinstance(activate, str):
        ...
        activate = {
            ...
            "Sigmoid": nn.Sigmoid,
            "LeakyReLU":nn.LeakyReLU(negative_slope=alpha, inplace=True),
        }[activate]
    return  activate
