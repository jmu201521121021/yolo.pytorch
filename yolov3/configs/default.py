...
def get_default_config():
    ...
    CFG.MODEL.MOBILENETV1.EXPAND_RATIO = 1

    ## mobilenetv2_config
    CFG.MODEL.MOBILENETV2 = edict()

    CFG.MODEL.MOBILENETV2.NORM = "BN"
    CFG.MODEL.MOBILENETV2.ACTIVATE = "ReLU"
    CFG.MODEL.MOBILENETV2.ACTIVATE_ALPHA = 0
    CFG.MODEL.MOBILENETV2.OUT_FEATURES = ["res4", "res5", "linear"]
    CFG.MODEL.MOBILENETV2.NUM_CLASSES = 10
