...
def get_default_config():
    ...
    ## mobilenet config
    CFG.MODEL.MOBILENET_V2 = edict()

    CFG.MODEL.MOBILENET_V2.OUT_FEATURES = ["res5"] # or ["res3", "res4", "res5"](train yolov3)
    CFG.MODEL.MOBILENET_V2.NORM = "BN"
    CFG.MODEL.MOBILENET_V2.ACTIVATE = "ReLU"
    CFG.MODEL.MOBILENET_V2.ACTIVATE_ALPHA = 0
    CFG.MODEL.MOBILENET_V2.NUM_CLASSES = 1000
    CFG.MODEL.MOBILENET_V2.LINEAR_KERBER_SIZE = 3
    CFG.MODEL.MOBILENET_V2.RATIO = 2
