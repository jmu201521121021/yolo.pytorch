...
def get_default_config():
    ...
    ## mobilenet config
    CFG.MODEL.MOBILENET_V1 = edict()

    CFG.MODEL.MOBILENET_V1.NORM = "BN"
    CFG.MODEL.MOBILENET_V1.ACTIVATE = "ReLU"
    CFG.MODEL.MOBILENET_V1.OUT_FEATURES = ["dw5", "linear"]
    CFG.MODEL.MOBILENET_V1.NUM_CLASSES = 10
